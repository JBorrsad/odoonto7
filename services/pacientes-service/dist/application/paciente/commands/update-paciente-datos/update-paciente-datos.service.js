...
exports.UpdatePacienteDatosService = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const oxide_ts_1 = require("oxide.ts");
const update_paciente_datos_command_1 = require("./update-paciente-datos.command");
const common_1 = require("@nestjs/common");
const paciente_di_tokens_1 = require("../../../../config/modules/paciente.di-tokens");
const shared_1 = require("@odoonto7/shared");
let UpdatePacienteDatosService = class UpdatePacienteDatosService {
...
exports.UpdatePacienteDatosService = UpdatePacienteDatosService;
exports.UpdatePacienteDatosService = UpdatePacienteDatosService = __decorate([
    (0, cqrs_1.CommandHandler)(update_paciente_datos_command_1.UpdatePacienteDatosCommand),
    __param(0, (0, common_1.Inject)(paciente_di_tokens_1.PACIENTE_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], UpdatePacienteDatosService);
//# sourceMappingURL=update-paciente-datos.service.js.map