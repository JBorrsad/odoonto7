...
exports.UpdatePacienteNotasService = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const oxide_ts_1 = require("oxide.ts");
const update_paciente_notas_command_1 = require("./update-paciente-notas.command");
const common_1 = require("@nestjs/common");
const paciente_di_tokens_1 = require("../../../../config/modules/paciente.di-tokens");
const shared_1 = require("@odoonto7/shared");
let UpdatePacienteNotasService = class UpdatePacienteNotasService {
...
exports.UpdatePacienteNotasService = UpdatePacienteNotasService;
exports.UpdatePacienteNotasService = UpdatePacienteNotasService = __decorate([
    (0, cqrs_1.CommandHandler)(update_paciente_notas_command_1.UpdatePacienteNotasCommand),
    __param(0, (0, common_1.Inject)(paciente_di_tokens_1.PACIENTE_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], UpdatePacienteNotasService);
//# sourceMappingURL=update-paciente-notas.service.js.map