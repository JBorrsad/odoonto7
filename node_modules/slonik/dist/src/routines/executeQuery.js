        ...
        transformRow: (executionContext, actualQuery, row) => {
            ...
            if (!validationResult.success) {
                log.error({
                    ...
                    row: (0, utilities_1.sanitizeObject)(row),
                    sql: actualQuery.sql,
                }, 'row failed validation');
                throw new errors_1.SchemaValidationError(actualQuery, (0, utilities_1.sanitizeObject)(row), validationResult.error.issues);
            }
