...
import { UpdatePacientePatologiasCommand } from '../../application/paciente/commands/update-paciente-patologias/update-paciente-patologias.command';
...
export class UpdatePacientePatologiasHttpController {
  ...
  @Patch(`${routesV1.pacientes.root}/:id/patologias`)
