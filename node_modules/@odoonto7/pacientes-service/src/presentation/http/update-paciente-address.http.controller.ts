...
import { UpdatePacienteAddressCommand } from '../../application/paciente/commands/update-paciente-address/update-paciente-address.command';
...
export class UpdatePacienteAddressHttpController {
  ...
  @Patch(`${routesV1.pacientes.root}/:id/address`)
  async updateAddress(
