...
import { UpdatePacienteMedicacionCommand } from '../../application/paciente/commands/update-paciente-medicacion/update-paciente-medicacion.command';
...
export class UpdatePacienteMedicacionHttpController {
  ...
  @Patch(`${routesV1.pacientes.root}/:id/medicacion`)
