...
import { UpdatePacienteEmbarazadaCommand } from '../../application/paciente/commands/update-paciente-embarazada/update-paciente-embarazada.command';
...
export class UpdatePacienteEmbarazadaHttpController {
  ...
  @Patch(`${routesV1.pacientes.root}/:id/embarazada`)
